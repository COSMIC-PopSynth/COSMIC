...
def zcnsts(z):
    ...
    *
    ...
    # dTbgb/dz
    msp(117) = dlzs*(xt[2]+lzs*(2.0*xt(3)+3.0*lzs*xt(4)))
    msp(118) = dlzs*(xt(6)+lzs*(2.0*xt(7)+3.0*lzs*xt(8)))
    msp(119) = dlzs*(xt(10)+lzs*(2.0*xt(11)+3.0*lzs*xt(12)))
    msp(120) = dlzs*(xt(14)+lzs*(2.0*xt(15)+3.0*lzs*xt(16)))
    ...
    &           msp(59)*m2**(msp(61)+1.50))/(msp(60)+m2**5)
    ...
    if(z.lt.0.0040) msp(74) = min(0.055,msp(74))
    ...
    msp(86) = min(xr(102)+lzs*xr(103),max(2.0,-13.3-18.6*lzs))
    ...
    if(lzs.gt.-1.0)then
     gbp(46) = 1.0 - xh(19)*(lzs+1.0)**xh(18)
    else
     gbp(46) = 1.0
    endif
    ...
    gbp(46) = gbp(46)/zpars[3]**0.10+(gbp(46)*gbp(47)-gbp(45))/
    &          zpars[3]**(gbp(48)+0.10)
    ...
    gbp(63) = xh(68)
    if(lzd.gt.0.0) then
     gbp(64) = 1.0-lzd*(xh(69)+lzd*(xh(70)+lzd*xh(71)))
    else
     gbp(64) = 1.0
    end if
    gbp(65) = 1.0-gbp(64)*dum1**gbp(63)
    gbp(66) = 1.0 - lzd*(xh(77) + lzd*(xh(78) + lzd*xh(79)))
