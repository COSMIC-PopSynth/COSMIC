...
class Sample(object):
    ...
    def sample_SFH(self, SFH_model='const', component_age=10000.0, met=0.02, size=None):
        ...
        if SFH_model=='const':
            ...
            m_tot = np.array([2.08674344e+06, 6.74121011e+06, 7.31214106e+07,\
            ...
            m_tot = np.array([3.21992825e+06, 1.09562694e+07, 1.23225953e+08,\
