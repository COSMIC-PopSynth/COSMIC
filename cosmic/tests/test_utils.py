...
class TestUtils(unittest2.TestCase):
    ...
    def test_error_check(self):
        ...
        convergence = {'convergence_params': ['mass_1', 'mass_2', 'porb', 'ecc'], 'conv_filter': 'formation', 'match': -5.0}
        sampling = {'initial_samp': 'multidim', 'galaxy_component': 'DeltaBurst', 'metallicity': 0.02}
