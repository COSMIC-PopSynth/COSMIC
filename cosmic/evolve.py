...
class Evolve(Table):
    ...
    def evolve(cls, initialbinarytable, BSEDict, **kwargs):
        ...
        initial_conditions = initialbinarytable[['kstar_1', 'kstar_2', 'mass1_binary', 'mass2_binary', 'porb', 'ecc',
                                                ...
                                                'cekickflag', 'ceflag', 'tflag', 'ifflag', 'wdflag', 'ppsn', 'bhflag', 'nsflag',
        ...
        def _evolve_single_system(f):
            try:
                ...
                bpp_bin_numbers = np.atleast_2d(np.array([f[42]] * len(bpp))).T
                bcm_bin_numbers = np.atleast_2d(np.array([f[42]] * len(bcm))).T
